...
function Get-InteractiveInput {
    ...
    Write-Host ""
    Write-Host "╔═══════════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
    Write-Host "║                    🛡️  ANONYMOUSHOUND v0.3 BETA                 ║" -ForegroundColor Cyan
...
"@
        ...
        <footer role="contentinfo">
            <p>Generated by <strong>AnonymousHound v0.3 BETA</strong> - BloodHound Data Anonymization Tool</p>
...
Write-Host "`nBloodHound Data Anonymization Script v0.3 BETA" -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
